...
const Contact = () => {
  return (
    <section id="contact" className="px-4 pb-20 md:px-8 2xl:px-0">
      <div className="relative mx-auto max-w-c-1390 px-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
        ...
        <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
          <div className="animate_top w-full rounded-lg bg-white p-7.5 shadow-solid-8 dark:border dark:border-strokedark dark:bg-black md:w-3/5 lg:w-3/4 xl:p-15">
            ...
            <form
              action="https://formsubmit.co/servelogy@gmail.com"
              method="POST"
            >
          ...
          <div className="animate_top w-full md:w-2/5 md:p-7.5 lg:w-[26%] xl:pt-15">
            ...
            {/* <div className="5 mb-7">
                ...
                <p>
                  440, RAM NAGAR, INDRA BASTI, SECTOR-B, STREET NO-2 WARD NO-4,
                  SUNAM, DISTT SANGRUR, PUNJAB- 148028.
                </p>
              </div> */}
            <div className="5 mb-7">
              <h3 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">
              ...
              <p>
                <a href="#">contact@engageenhance.com</a>
              </p>
            </div>
            <div>
